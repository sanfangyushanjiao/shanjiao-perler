...
const PURCHASE_URL = 'https://m.tb.cn/h.i27Dfb6?tk=aXENUuyJZuU';
...
export const ActivationModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-16 max-w-sm sm:max-w-md lg:max-w-4xl xl:max-w-5xl w-full my-auto">
        {/* Logo/Icon */}
